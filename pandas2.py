...
# print(wynik)
# wynik.plot(figsize=(6, 6), ylabel="liczba narodzin [tys.]", xticks=wynik.index, rot=45, grid=True, title="Tytul")
# plt.show()
...
# print(wynik2)
# wynik.plot(kind="pie",autopct="%.2f %%", ylabel="liczba urodzeń",title="całkowita liczb urodzen w latach 2013-2017")
# plt.show()
...
# wynik.plot.barh(title="Liczba zamowien dla poszczegolnych sprzedawców")
# print(wynik)
# plt.show()
